                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="log_chat_area d-flex align-items-center">
                                <a class="btn btn-primary " href="../admin/index.php" role="button" style="border-radius: 50px;">
                                    <i class="flaticon-user"></i> <span>Login Admin</span></a>


                                <a href="../admin/index.php" class="login popup-with-form">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            <h3>Pelajari Bahasa <br>
                                 Pemograman Kamu <br>
                                Dengan Istudy</h3>
                             <a class="btn btn-primary btn-lg " href="../login.php" role="button" style="border-radius: 50px;">
                            <span>Login User</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="single_about_info">
                        <h3>Tersedia Soal-Soal <br>
                            Untuk mengetahui pemahaman</h3>
                        <p>Kita dapat memilih kategori soal bahasa pemograman yang kita pelajari agar kita dapat mengetahui sejauh mana kita memahami bahasa pemograman yang kita pelajari </p>
                        <a href="../register.php" class="boxed_btn">Daftar Sekarang</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        ...
                        <p>I study menyediakan beberapa bahasa pemograman dari web, dekstop, hingga Aplikasi</p>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="img/courses/php2.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>PHP</span>
                                                <h3><a href="#">Menyedikan soal soal dasar php
                                                        hingga tingkat advance</a></h3>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="img/courses/js.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="img/courses/c2.png" alt="" style="height: 250px;">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>Wordpress</span>
